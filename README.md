...
-------
    git clone https://github.com/<git-repo-id>/spring-cloud-kubernetes.git
...
--------------
    docker build -t <git-repo-id>/kubernetes-configmap-reload .
...
-----------
    docker push <git-repo-id>/kubernetes-configmap-reload
